...
===== Curl
include::{snippets}/{user}/join_username_uk_fail_test/curl-request.adoc[]
...
===== Curl
include::{snippets}/{user}/check_username_available_test/curl-request.adoc[]
...
===== Curl
include::{snippets}/{board}/list_test/curl-request.adoc[]